...
const EnterIncomeCard: React.FC<EnterIncomeCardProps> = ({ 
  ...
  return (
    <div className={`h-full p-6 rounded-[32px] backdrop-blur-xl border shadow-2xl flex flex-col justify-between relative overflow-hidden group transition-all duration-500 ${
      isDarkMode 
      ...
      <div className="flex-1 overflow-y-auto pr-1 -mr-1 custom-scrollbar"> 
        ...
        <div className="mb-3 relative z-10">
            <div className={`border rounded-2xl px-5 py-2.5 flex justify-between items-center cursor-pointer transition-all shadow-lg ${
              isDarkMode 
        ...
        {/* Amount Input */}
        <div className="mb-5 relative group/input z-10">
            ...
            <input
                ...
                className={`appearance-none w-full border pl-9 pr-4 py-2 rounded-2xl text-xl font-light focus:outline-none focus:ring-1 transition-all shadow-inner ${
                  isDarkMode 
                    ? 'bg-[#161621] border-white/[0.08] text-white focus:border-purple-500/50 focus:ring-purple-500/50 placeholder-gray-700 shadow-black/40' 
                    : 'bg-slate-50 border-slate-200 text-slate-800 focus:border-purple-400/50 focus:ring-purple-400/50 placeholder-slate-300 shadow-inner'
                }`}
                placeholder="0.00"
            />
        </div>
        ...
        <div className="mb-3 relative z-10">
            <div className={`flex items-stretch border rounded-2xl overflow-hidden transition-all ${
                 isDarkMode 
                    ? 'bg-[#161621] border-white/[0.08]' 
                    : 'bg-white border-slate-200'
            }`}>
                {/* Start Date */}
                <div className={`flex-1 flex flex-col justify-center px-4 py-3 border-r relative group/start ${isDarkMode ? 'border-white/[0.08]' : 'border-slate-200'}`}>
                ...
                {/* End Date */}
                <div className="flex-1 flex flex-col justify-center px-4 py-3 relative group/end">
                    <div className="flex items-center">
                         <input 
                            ref={periodEndRef}
                            type="date"
        ...
        <div className="mb-5 relative z-10 grid grid-cols-2 gap-3">
             ...
             <div className="relative">
                <div className={`flex items-center border rounded-2xl px-4 py-3 relative h-full ${
                     isDarkMode 
                        ? 'bg-[#161621] border-white/[0.08]' 
                        : 'bg-white border-slate-200'
             ...
             <div className="relative" ref={dropdownRef}>
                <div 
                    ...
                    className={`flex items-center justify-between border rounded-2xl px-4 py-3 cursor-pointer transition-all h-full ${
                         isDarkMode 
                ...
                {isCompanyDropdownOpen && (
                    <div className={`absolute top-full left-0 right-0 mt-2 rounded-2xl border shadow-xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200 ${
                         isDarkMode 
                        ...
                        <div className="max-h-40 overflow-y-auto custom-scrollbar">
                            {companies.map(company => (
                                <div 
                                    ...
                                    className={`px-4 py-2.5 flex items-center text-xs font-medium cursor-pointer transition-colors ${
                                        isDarkMode 
                        ...
                        <div 
                            ...
                            className={`px-4 py-2.5 border-t flex items-center text-xs font-medium cursor-pointer transition-colors ${
                                isDarkMode 
      ...
      <div className="space-y-3 pt-3 relative z-10 border-t border-transparent mt-auto">
        <button 
            onClick={onReset}
            className={`w-full py-3.5 rounded-2xl text-sm font-medium transition-all duration-300 ${
              isDarkMode 
    ...
    <div className="flex justify-between items-center text-sm group min-h-[30px] px-1">
        ...
        <div className="relative w-24 h-8 flex items-center">
            ...
            <input 
                ...
                className={`appearance-none w-full bg-transparent text-right outline-none border-b border-transparent focus:border-purple-500 font-light transition-all text-sm pb-1 px-0 ${
                  isDarkMode 
